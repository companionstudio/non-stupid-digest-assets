...
Gem::Specification.new do |s|
  ...
  s.summary     = "Fix the Sprockets asset pipeline to generate non-digest along with digest assets"
  s.description = <<-DESCRIPTION
    Sprockets, as of Rails 4, provides no option to generate both digest
